        ...
        <br>
            <div class="card">
                <div class="card-header text-center">
                    Editar Post ID: <b><?php echo $idpost; ?></b>
                </div>
                <div class="card-body">
                    <form action="atualiza.php" method="POST">
                        <div class="form-group text-center">
                            <label for="nome">Titulo</label>
                            <input type="hidden" class="form-control" name="id" value="<?php echo $idpost; ?>">
                            <input type="text" class="form-control" name="titulo" value="<?php echo $titulo; ?>">
                        </div>
                        <div class="form-group text-center">
                            <label for="nome">Conteudo</label>
                            <input type="text" class="form-control" name="conteudo" value="<?php echo $conteudo; ?>">
                        </div>
                        <br>
                        <div class="form-group text-center">
                            <label for="nome">Categoria</label>
                            <select class="form-control select2 text-center" name="idcategoria" required>
                                  <option value="<?php echo $idcat; ?>"  selected hidden><?php echo $idcat . " - " . $categoria; ?></option>
                                      <?php
                                            $conecta = new Sistema();
                                            ...
                                            while($cat = $resultcat->fetch(PDO::FETCH_ASSOC))
                                              {
                                        ?>
                                    <option value="<?php echo $cat['idcat']; ?>"><?php echo $cat['idcat'] . " - " . $cat['nomecat']; ?></option>
                                        <?php
                                              }
                                        ?>
								  	        </select>
                        ...
                        <div class="form-group text-center">
                            ...
                            <select class="form-control select2 text-center" name="idusuario" required>
                                  <option value="<?php echo $iduser; ?>"  selected hidden><?php echo $iduser . " - " . $usuario; ?></option>
                                      <?php
                                            $conecta = new Sistema();
                                            $link = $conecta->conectado();
                                            ...
                                            while($user= $resultuser->fetch(PDO::FETCH_ASSOC))
                                              {
                                        ?>
                                    <option value="<?php echo $user['idusuario']; ?>"><?php echo $user['idusuario'] . " - " . $user['nomeuser']; ?></option>
                                        <?php
                                              }
                                        ?>
								  	        </select>
