                        ...
                        ?>
                            <tr>
                                ...
                                <td class="text-center">
                                    ...
                                    <a href="editar.php?id=<?php echo $id; ?>" class="btn btn-warning" role="button"><i class="fa fa-fw fa-edit"></i>&nbsp;&nbsp;Editar</a>
                                    <a href="excluir.php?id=<?php echo $id; ?>" class="btn btn-danger" role="button"><i class="fa fa-fw fa-trash"></i>&nbsp;&nbsp;Excluir</a>
                                </td>
                            </tr>
                        <?php 
                            }           
