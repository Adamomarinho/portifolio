        ...
        <br>
            <div class="card">
                <div class="card-header text-center">
                    Editar Nivel ID: <b><?php echo $idnvl; ?></b>
                </div>
                <div class="card-body">
                    <form action="atualiza.php" method="POST">
                        <div class="form-group text-center">
                            <label for="nome">Nome</label>
                            <input type="hidden" class="form-control" name="id" value="<?php echo $idnvl; ?>">
                            <input type="text" class="form-control" name="nivel" value="<?php echo $nomenvl; ?>">
                        </div>
                        <br>
                        <div class="form-group text-center">
