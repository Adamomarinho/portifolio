            ...
            <div class="text-center">
                ...
                <br>
                    <table id="tabela" class="table table-striped" style="width:100%">
                        ...
                        ?>
                            <tr>
                                <td class="text-center"><?php echo $idnivel; ?></td>
                                <td class="text-center"><?php echo $nomenivel; ?></td>
                                <td class="text-center">
                                    <a href="ver.php?id=<?php echo $idnivel; ?>" class="btn btn-info" role="button"><i class="fa fa-eye"></i>&nbsp;&nbsp;Ver</a>
                                    <a href="editar.php?id=<?php echo $idnivel; ?>" class="btn btn-warning" role="button"><i class="fa fa-fw fa-edit"></i>&nbsp;&nbsp;Editar</a>
                                    <a href="excluir.php?id=<?php echo $idnivel; ?>" class="btn btn-danger" role="button"><i class="fa fa-fw fa-trash"></i>&nbsp;&nbsp;Excluir</a>
                                </td>
                            </tr>
                        <?php 
                            }           
