...
<html lang="en">
  ...
  <meta charset="utf-8">
    ...
    <title>Visualiza Categorias de Posts</title>
            ...
            <div class="text-center">
                ...
                <div class="card">
                    <div class="card-header text-center">
                        Visualizar dados da Categoria: <b><?php echo $idcat; ?></b>
                    </div>
                    <div class="card-body">
                        <br>
                        <p class="card-text text-center"><b>ID:</b> <?php echo $idcat; ?></p>
                        <p class="card-text text-center"><b>Nome:</b> <?php echo $nomecat; ?></p>
                    </div>
                    <div class="card-footer text-center">
                        <a href="gerenciar.php" class="btn btn-success" role="button" style="text-decoration: none;"><i class="fa fa-list fa fa-fw"></i>&nbsp;&nbsp;Gerenciar Categorias</a>
                        <a href="novo.php" class="btn btn-primary" role="button" style="text-decoration: none;"><i class="fa fa-plus fa fa-fw"></i>&nbsp;&nbsp;Adicionar</a>
                        <a href="editar.php?id=<?php echo $idcat; ?>" class="btn btn-warning" role="button" style="text-decoration: none;"><i class="fa fa-edit fa fa-fw"></i>&nbsp;&nbsp;Editar</a>
                        <a href="excluir.php?id=<?php echo $idcat; ?>" class="btn btn-danger" role="button" style="text-decoration: none;"><i class="fa fa-trash fa fa-fw"></i>&nbsp;&nbsp;Excluir</a>
                    </div>
                </div>
