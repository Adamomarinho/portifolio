...
$log = new Logs();
$ip = $log->PegaIp();
$log->SalvarLogs($nomeusuario,$ip,'Este usuario cadastrou um novo Post');
        ...
        <br><br>
            <div class="card">
                ...
                <?php    
                    ...
                    $add = new PostsCrud();
                    if($add->SalvarPost($titulo,$conteudo,$situacao,$categoria,$usuario))
                    {
                      msg('success', 'Post adicionado com sucesso!');
                      redireciona(3, $destino);
                    }
                    else
                    {
                      msg('danger', 'Não foi possivel adicionar o Post');
                      redireciona(3, $destino);
                    }
